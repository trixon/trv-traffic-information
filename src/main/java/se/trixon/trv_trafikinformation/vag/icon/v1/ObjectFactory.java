...
package se.trixon.trv_trafikinformation.vag.icon.v1;
 ...
 * generated in the se.trixon.trv_trafikinformation.vag.icon.v1 package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: se.trixon.trv_trafikinformation.vag.icon.v1
     * 
     */
