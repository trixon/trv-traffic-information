 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Situation" type="{}DynamicObjectType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class RESULT {
    ...
    protected List<DynamicObjectType> situation;
     ...
     * 
     */
    public List<DynamicObjectType> getSituation() {
        if (situation == null) {
            situation = new ArrayList<DynamicObjectType>();
        }
